...
public interface INumberSequenceService
{
    ...
    Task<string> GenerateNextCodeAsync(Guid tenantId, string entityPrefix, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    Task ResetSequenceAsync(Guid tenantId, string entityPrefix, int newNumber, CancellationToken cancellationToken = default);
}
